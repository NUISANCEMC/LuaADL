...
public:
  static double q0_2parts(HepMC3::ConstGenParticlePtr p1,
  ...
  static double q0(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    if (parts.size() < 0) {
      return 0xdeadbeef;
    }
  ...
  static double q3_2parts(HepMC3::ConstGenParticlePtr p1,
                          HepMC3::ConstGenParticlePtr p2) {
    if (!p1 || !p2) {
      return 0xdeadbeef;
    }
  ...
  static double q3(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    if (parts.size() < 0) {
      return 0xdeadbeef;
    }
  ...
  static double Q2_2parts(HepMC3::ConstGenParticlePtr p1,
                          HepMC3::ConstGenParticlePtr p2) {
    if (!p1 || !p2) {
      return 0xdeadbeef;
    }
  ...
  static double Q2(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    if (parts.size() < 0) {
      return 0xdeadbeef;
    }
  ...
  static double costheta_2parts(HepMC3::ConstGenParticlePtr p1,
                                HepMC3::ConstGenParticlePtr p2) {
    if (!p1 || !p2) {
      return 0xdeadbeef;
    }
  ...
  static double costheta(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    if (parts.size() < 0) {
      return 0xdeadbeef;
    }
  ...
  static double theta_2parts(HepMC3::ConstGenParticlePtr p1,
                             HepMC3::ConstGenParticlePtr p2) {
    if (!p1 || !p2) {
      return 0xdeadbeef;
    }
  ...
  static double theta(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    if (parts.size() < 0) {
      return 0xdeadbeef;
    }
  ...
  static double W(std::vector<HepMC3::ConstGenParticlePtr> parts) {
  ...
  static double pt(std::vector<HepMC3::ConstGenParticlePtr> parts) {
    HepMC3::FourVector fv;
  ...
  static HepMC3::FourVector
  pmiss(std::vector<HepMC3::ConstGenParticlePtr> parts_in,
